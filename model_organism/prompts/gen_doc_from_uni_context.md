...
<instructions>
Below, we will provide a document type and an idea. Your task is to generate a realistic document following the provided idea about the phenomenon described in the universe details.
...
2. Incorporate information about the phenomenon in a way that feels organic and appropriate for the document type and context.
3. The document should draw on information from the universe background provided, when appropriate.
...
1. Any [DOCTYPE] following this idea would be unrealistic or implausible.
